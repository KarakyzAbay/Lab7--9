...
bg = pygame.image.load(os.path.normpath('c:\\Users\\User\\Pictures\\bg.png'))
bg = pygame.transform.scale(bg, (window_width, window_height))
hand_second_img = pygame.image.load(os.path.normpath('c:\\Users\\User\\Pictures\\hand_second.png'))
hand_second_img = pygame.transform.scale(hand_second_img, (150, 400))
hand_minute_img = pygame.image.load(os.path.normpath('c:\\Users\\User\\Pictures\\hand_minute.png'))
